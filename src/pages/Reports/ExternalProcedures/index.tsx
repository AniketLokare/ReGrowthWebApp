...
import {
  viewProcedureReportBreadCrumbLinks,
  ExternalProceduresReportTableColumns,
} from '../../ExternalProcedures/constants';
...
const ExternalProcedures: React.FC = (): JSX.Element => {
  ...
  const { response, isFetching, isError, refetch } =
            ...
            <Stack spacing={2}>
              ...
              >
                ...
                >
                  ...
                  <Stack
                    spacing={6}
                    sx={{ marginTop: '13px', paddingLeft: '20px' }}
                  >
                    ...
                    >
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <InfoField
                          ...
                          //he above finalAmountTotal tula dashboard card vr show karaychi aahe
                        />
                      </Box>
                    </Box>
                  </Stack>
